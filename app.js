...
function main(tg) {
    ...
    const UPGRADES = {
        ...
        'asic-rig':       { name: 'ASIC Rig',       icon: '⚙️', baseCost: 600,     baseProfit: 150 },
        'data-center':    { name: 'Data Center',    icon: '🏢', baseCost: 5000,    baseProfit: 750 },
        'quantum-comp':   { name: 'Quantum Comp',   icon: '⚛️', baseCost: 40000,   baseProfit: 3500 },
        'fusion-reactor': { name: 'Fusion Reactor', icon: '☀️', baseCost: 500000,  baseProfit: 20000 },
        'dyson-sphere':   { name: 'Dyson Sphere',   icon: '🌌', baseCost: 10000000, baseProfit: 150000 }
    };
