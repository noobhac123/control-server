...
function main(tg) {
    ...
    const UPGRADES = {
        'gpu-miner':      { name: 'GPU Miner',      icon: '💻', baseCost: 50,       baseProfit: 25 },
        'asic-rig':       { name: 'ASIC Rig',       icon: '⚙️', baseCost: 800,      baseProfit: 100 },
        'data-center':    { name: 'Data Center',    icon: '🏢', baseCost: 6000,     baseProfit: 500 },
        'quantum-comp':   { name: 'Quantum Comp',   icon: '⚛️', baseCost: 50000,    baseProfit: 2500 },
        'fusion-reactor': { name: 'Fusion Reactor', icon: '☀️', baseCost: 500000,   baseProfit: 15000 },
        'dyson-sphere':   { name: 'Dyson Sphere',   icon: '🌌', baseCost: 10000000, baseProfit: 125000 }
    };
    ...
    async function loadUserData() {
        ...
        if (snapshot.exists()) {
            ...
            if (!state.upgrades['fusion-reactor']) state.upgrades['fusion-reactor'] = { level: 0 };
            if (!state.upgrades['dyson-sphere']) state.upgrades['dyson-sphere'] = { level: 0 };
