...
function main(tg) {
    ...
    function startLoadingAnimation(duration) {
        const animationInterval = 50; // ms
        let progress = 0;
        const increment = 100 / (duration / animationInterval);
        ...
        const loaderInterval = setInterval(() => {
            ...
            if (dom.loadingPercent && dom.loadingBarFill) {
    ...
    async function initializeApp() {
        ...
        const minSplashTime = 4000; // 4 seconds
        const loaderInterval = startLoadingAnimation(minSplashTime);
